...
tf.flags.DEFINE_string('X_input_dir', 'data/cezanne2photo/trainA',
                       'X input directory, default: data/cezanne2photo/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/cezanne2photo/trainB',
                       'Y input directory, default: data/cezanne2photo/trainB')
